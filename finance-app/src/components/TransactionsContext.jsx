...
// Get stored transactions from localStorage if available
const getStoredTransactions = () => {
  const storedTransactions = localStorage.getItem('transactions');
  return storedTransactions ? JSON.parse(storedTransactions) : data.transactions || [];
};
...
// Get stored pots from localStorage if available
const getStoredPots = () => {
...
export const TransactionsProvider = ({ children }) => {
  const [transactions, setTransactions] = useState(getStoredTransactions); // Use transactions from localStorage
  ...
  // Save pots to localStorage when they change
  useEffect(() => {
  ...
  return (
    <TransactionsContext.Provider value={{
      ...
      addBudget, updateBudget, deleteBudget, addPot, updatePot, deletePot, transactions, setTransactions, // Add these to the context
      addTransaction // Expose functions
    }}>
      {children}
