...
//       <div className='flex items-center justify-between mb-4'>
//         <h2 className="text-lg font-bold ">Budgets</h2>
//         <button className='text-white text-sm bg-black p-3 rounded-2xl'>+ Add New Budget</button>
//       </div>
//       <div className='flex w-full flex-col lg:flex-row'>
//         <div className='w-full lg:w-[40%] '>Summary section</div>
//         <div className='w-full lg:w-[60%] h-[80vh] lg:h-[85vh] overflow-y-auto scroll-hidden'>
//           <ul>
//           {budgets.map((budget) => {
//             const { totalSpent, remaining } = getSpentAndRemaining(budget.category, budget.maximum);
